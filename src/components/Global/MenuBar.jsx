...
const MenuBar = () => {
    const activeLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded  text-white  text-sm  ';
    const normalLink = 'flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded text-sm text-gray-700 hover:bg-gray-200 ';
    const deadLink = ''
