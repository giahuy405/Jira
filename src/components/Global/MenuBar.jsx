...
const MenuBar = () => {
    ...
    const activeLink = 'flex items-center gap-3 pl-4 pt-2 pb-2  rounded  text-blue-600 bg-gray-200  text-sm  font-semibold ';
    const normalLink = 'flex items-center gap-3 pl-4 pt-2 pb-2  rounded text-sm text-gray-700 hover:bg-gray-200 font-semibold  ';
                ...
                <div className='fixed left-[65px] p-5 bg-[#F4F5F7] h-screen overflow-auto md:overflow-hidden md:hover:overflow-auto w-[230px] border-r border-color hidden md:block '>
                    <div className='fixed -top-2 left-[250px]'>
                        ...
                        <button
                            ...
                            className="text-sm rounded-full p-1.5 hover:bg-light-gray mt-4 block text-gray-400 hover:bg-gray-200 border border-color"
                        >
                    ...
                    <div className='flex gap-2 mb-8'>
                        ...
                        <div className='text-sm text-gray-600'>
                            <h3 className='font-semibold'>Singularity 7.0</h3>
                            <p className='text-xs'>Software project</p>
                        </div>
                    </div>
                    {links.map((item) => (
                        <div key={item.title} className='mb-3' >
                            <p className="text-gray-400 dark:text-gray-400 my-1 border-t border-color pt-2">
                                {item.title}
                            </p>
                            {item.links.map((link) => (
                                <NavLink
            ...
            }
            {
                ...
                <div className='w-[65px] relative'>
                    <button
                        ...
                        className="text-lg rounded-full p-2 hover:bg-light-gray mt-3 block text-white bg-[#0548a6ea] hover:bg-[#3565a8] absolute left-[78px]  "
                    >
