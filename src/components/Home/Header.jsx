        ...
        <header className="bg-white shadow-md">
            <div className="container flex justify-between px-2 mx-auto">
                ...
                <ul className="items-stretch hidden space-x-3 lg:flex">
                    <li className="flex">
                        <NavLink to='/login' className='flex items-center px-4'>Login</NavLink>
                    </li>
                    <li className="flex">
                        <NavLink to='/contact' className='flex items-center px-4'>Contact</NavLink>
                    </li>
                    <li className="flex">
                        <NavLink to='/about' className='flex items-center px-4'>About</NavLink>
                    </li>
                    <li className="flex">
                        <a rel="noopener noreferrer" href="#" className="flex items-center px-4  dark:border-transparent">Link</a>
                    </li>
                </ul>
                <div className="items-center flex-shrink-0 hidden lg:flex">
                    <button className="self-center px-4 py-2 rounded">Sign in</button>
                    <button className="self-center px-4 py-2 font-semibold rounded ">Sign up</button>
                </div>
