  ...
  return (
    <AuthLayout>
      <div className='bg-gray-100 h-screen pt-6 md:bg-hero-pattern bg-cover bg-center relative w-screen '>
        <div className="flex flex-col md:w-[500px] w-full h-full md:h-fit  bg-white shadow-2xl p-6 sm:p-10 sm:py-6 absolute z-10 top-1/2  left-1/2 -translate-x-1/2 -translate-y-1/2 rounded dark:bg-secondary-dark dark:text-white border border-gray-500">
